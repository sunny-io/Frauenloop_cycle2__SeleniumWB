...
const chromeObj = new chromeCalculator();
const firefoxObj = new firefoxCalculator();
const safariObj = new safariCalculator();
...
[safariObj, firefoxObj, chromeObj].forEach((calculator) => {
  describe("Testsuit for simple Calculator " + calculator.browser, function () {
    //remove --no-timeouts
    this.timeout(0);
